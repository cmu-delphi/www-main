...
post](`r blogdown::shortcode_html("ref", "2020-08-26-fb-survey#why-run-these-surveys")`),
...
[^1]:
    ...
    correlations](`r blogdown::shortcode_html("ref", "2020-08-26-fb-survey#basic-correlation-analysis")`)
...
documentation](`r blogdown::shortcode_html("apiref", "api/covidcast-signals/google-survey.html")`).
...
suggested](`r blogdown::shortcode_html("ref", "2020-08-26-fb-survey#basic-correlation-analysis")`)
...
questions](`r blogdown::shortcode_html("apiref", "symptom-survey/coding.html")`)
