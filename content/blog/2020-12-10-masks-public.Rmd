...
ggplot(mask_rest,
  ...
  geom_text() +
  labs(x = "% who report wearing masks most/all the time",
       y = "Restaurant visits by SafeGraph panel, per 100,000 population",
       title = "Social distancing and mask use",
       subtitle = "December 1st, 2020",
       caption = "Data from Delphi COVIDcast, delphi.cmu.edu") +
  theme_bw()
```
...
pandemic. By studying this aggregate data, and also the individual survey
