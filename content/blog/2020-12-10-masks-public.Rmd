...
pandemic. They survey has been completed 14 million times since April, allowing
us an unprecedented level of insight into COVID and people's experiences, down
to individual counties around the country.

[Since in early September](`r blogdown::shortcode("ref",
...
clients](https://cmu-delphi.github.io/delphi-epidata/api/covidcast_clients.html)
...
mobility
data](https://cmu-delphi.github.io/delphi-epidata/api/covidcast-signals/safegraph.html)
