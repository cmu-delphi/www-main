...
Early analysis suggests that mask usage is high in most states, and in those where it was lower, it has been gradually increasing. For example, the graph
...
* **Social desirability bias.** It's well-known that survey respondents can
  choose answers that seem socially desirable. If mask usage is widely
...
These biases are hard to measure directly. We don't have a way to tell if a
respondent is truthful, and since there's no objective national data on the
exact percentage of people wearing masks in public, we have no way to
