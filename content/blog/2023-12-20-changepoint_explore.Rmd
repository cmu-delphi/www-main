...
authors:
  - tara
  - ajoshi
heroImage: changepoint-blog.png
...
Interestingly, indicators from the same source were usually classified similarly, suggesting that the indicator timeliness depends heavily on the data provider that serves as the source for the indicators. Still, while there was some variance in the leadingness of early indicators, other categories had much less variance. 
...
<center>
![**Figure 4.** This on-time indicator has major indicator changepoints (blue bars) which occur within a two week window around the ground truth changepoints (black).](static/blog/2023-03-20-changepoint-blog-files/image1.png)</center>
...
<center>
![**Figure 5.** This variable indicator has changepoints (blue bars) which occur early and late relative to the critical changepoints (black) established using CDC data.](static/blog/2023-03-20-changepoint-blog-files/image4.png)
</center>
...
Overall, Changepoint detection is a powerful tool identify early indicators. Of Delphi's sixty indicators, we identified several on time and early indicators of emerging variants from the data available. We also found out that for many of the indicators the leading/lagingness of these indicators changed over time. Still, if these public health indicators continue to receive high quality data, tracking these indicators closely can help us identify changing health dynamics. 

Github Notebook [Here](https://github.com/TaraLakdawala/covid-changepoint-detection-exploration)
