...
author: Tara Lakadwala, Ananya Joshi
date: 2023-12-20
tags:
  - epidata
...
<center>
![**Figure 1.** Total and Variant Case Counts with variant changepoints on April 24, 2021; June 19, 2021; December 18, 2021; March 5, 2022; June 18, 2022.](changepoint/image3.png){width=70%}
</center>
...
<center>
![**Figure 2.** The aggregated count of changepoints per week in all fifty two regions by all three algorithms for estimated COVID related outpatient doctor visits](changepoint/image5.png){width=70%, height=50%}</center>
...
<center>
![**Figure 4.** This on-time indicator has major indicator changepoints (blue bars) which occur within a two week window around the ground truth changepoints (black).](changepoint/image1.png){width=70%, height=50%}</center>
...
<center>
![**Figure 5.** This variable indicator has changepoints (blue bars) which occur early and late relative to the critical changepoints (black) established using CDC data.](changepoint/image4.png){height=70%}
</center>
