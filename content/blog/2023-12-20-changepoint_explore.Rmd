...
Interestingly, indicators from the same source were usually classified similarly, suggesting that indicator timeliness depends heavily on the data provider. Still, while there was some variance in the "leadingness" of early indicators, other categories had much less variance. 
