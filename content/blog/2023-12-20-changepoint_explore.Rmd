...
```{r pressure, echo=FALSE, fig.cap="Total and Variant Case Counts with variant changepoints on April 24, 2021; June 19, 2021; December 18, 2021; March 5, 2022; June 18, 2022.", out.width = '70%'}
knitr::include_graphics("images/changepoint/image3.png")
```
...
<center>
![**Figure 2.** The aggregated count of changepoints per week in all fifty two regions by all three algorithms for estimated COVID related outpatient doctor visits](changepoint/image5.png)</center>
...
<center>
![**Figure 4.** This on-time indicator has major indicator changepoints (blue bars) which occur within a two week window around the ground truth changepoints (black).](changepoint/image1.png)</center>
...
<center>
![**Figure 5.** This variable indicator has changepoints (blue bars) which occur early and late relative to the critical changepoints (black) established using CDC data.](changepoint/image4.png)
</center>
