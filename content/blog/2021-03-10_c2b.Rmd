...
ggplot(data=df2, aes(x=CollectionDate, y=Counts, fill=Key), show.legend = FALSE) +
  ...
  labs(x = "Specimen Collection Date", y="",
       ...
       subtitle = "Hospitalizations Due to COVID-19 and New Cases from Positive PCR Tests",
       caption = "Delphi Group, delphi.cmu.edu, \nData from WPRDC") +
  theme_bw() +
  guides(color = FALSE) + facet_wrap(.~Key, scales = "free") + scale_x_date(name="Month", date_breaks="1 month", minor_breaks=NULL, date_labels="%b %Y")+ theme(legend.position = "none")

```

**Fig. 1:** Hospitalization and Positive Case Counts in Allegheny County From October 1st Through Dec 11th from WPRDC Data <sup>[2](#WPRDCLink)</sup>
...
These vary most by age (Fig 2), and to a lesser extent sex and race. 
...
<a id="WPRDCLink">2.</a>  [WPRDC Allegheny County COVID dataset](https://data.wprdc.org/dataset/allegheny-county-covid-19-tests-cases-and-deaths)
