...
**Fig. 1:** Hospitalization and Positive Case Counts in Allegheny County From October 1st Through Dec 11th from WPRDC Data <sup>[1](#WPRDCLink)</sup>
...
The ACHD team spent a significant amount of time every day examining many data streams and then only had time to look at a handful of the data slices worth monitoring. There was concern that a rise in cases within specific demographic groups would be missed due to a confluence of factors.
