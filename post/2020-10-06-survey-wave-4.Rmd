...
mask <- covidcast_signal("fb-survey", "wip_smoothed_wwearing_mask",
...
tested <- covidcast_signal("fb-survey", "wip_smoothed_wtested_14d",
                           start_day = end_day, end_day = end_day,
                           geo_type = "state")
...
positivity <- covidcast_signal("fb-survey", "wip_smoothed_wtested_positive_14d",
                               start_day = end_day, end_day = end_day,
                               geo_type = "state")
...
wanted_test <- covidcast_signal("fb-survey", "wip_smoothed_wwanted_test_14d",
                                start_day = end_day, end_day = end_day,
                                geo_type = "state")
