...
but for now, here's a couple quick plots. On the left is a state-level heatmap
of the estimated percentage of people COVID symptoms, based on our survey,
...
cover our covidcast R and Python packages in a future blog post.)
...
Lastly, here's some other useful links: 
the [complete text](TODO link to clean, public Google doc) of the survey
questions;  
a [preview version of the
survey](https://cmu.ca1.qualtrics.com/jfe/preview/SV_cT2ri3tFp2dhJGZ?Q_SurveyVersionID=current&Q_CHL=preview), 
which gives a fully functional click-through experience, but doesn't record
anything;
