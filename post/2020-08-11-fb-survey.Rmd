...
survey, advertised through Facebook, is taken by about 74,000 people every day.
...
processing the survey data and producing estimates. Taylor Arnold, Amartya Basu,
and Alex Reinhart provided huge help with refactoring and improving this 
codebase. Logan Brooks, Pratik Patil, Rob Tibshirani, and Ryan Tibshirani 
...
operation and our survey is taken by about 74,000 people every day. We believe 
that such a combination of *detail* and *scale* has never before been available 
via surveys in a public health emergency: we collect information on 
COVID-related symptoms, contacts, risk factors, and demographics, enabling us to
look at county-level trends across the US. We make aggregated data publicly 
available daily through our [COVIDcast
...
indicators of COVID-like illness that are derived from our surveys. In terms of
...
aggregated data is ever released publicly. As of this writing, our survey is
taken by an average of 74,000 people per day; delivers adequate data (enough for 
us to create meaningful estimates) for an average of nearly 1,000 counties per 
week; and has been taken over 10 million times so far. An [international version
of the survey](https://covidmap.umd.edu/), available in over 50 languages, was 
launched soon after by a team at the University of Maryland.

We'll go into detail later about our survey and our survey-based indicators, but 
for now, here's a couple of quick maps. On the left is a state-level heatmap of 
...
correlation between the % CLI indicator and COVID-19 case rates, across the
counties that had at least 500 cumulative confirmed COVID-19 cases. (Spearman
...
Next we compute, for each county with at least 500 cumulative cases, the
...
cumulative COVID-19 cases, or we didn't have enough data from the surveys in
...
As we explain above, beyond its first section, the survey contains many
questions on testing, behavior, medical care, mental health, and related topics, 
leading to a multitude of possible research questions.
