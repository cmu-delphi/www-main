...
data from our API, to producing the heatmaps---and requires only about 15 lines
of code. You can click the "code" button to reveal it. We'll cover our covidcast
[R and Python
