...
visualize it on our [COVIDcast interactive map](https://covidcast.cmu.edu/).
We also make (fully de-identified) individual survey responses available to 
...
smoothing) as a blue curve. We also plot the % CLI-in-community indicator as
a red curve. Note that these two curves, case counts and % CLI-in-community, are
