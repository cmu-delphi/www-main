...
shouldn't be subject to the same problems. This is a potentially very important
...
coronavirus infections over time. And in the best case, it can help predict
changes to come some days into the future.
...
the plots below, with COVID-19 cases in red and the % CLI-in-community indicator
in blue. We can see that the % CLI-in-community indicator is (a) never lagging
