...
**Forecasting** has long been a primary initiative of the Delphi group
...
as incorporated into forecasting or hotspot detection models, you might want to 
first check out our [previous exploratory
...
activity. In addition to more posts to come on forecasting, stay tuned into 
the Delphi blog for a post on hotspot detection soon.
