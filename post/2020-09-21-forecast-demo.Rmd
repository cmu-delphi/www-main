...
which you can find in the [same GitHub repo](https://github.com/cmu-delphi/delphi-blog/tree/main/content/post) 
as the Rmd source for this blog post. 
...
is consistently in the range of what we were seeing before (for 7 and 14 days ahead), 
...
the median scaled error of the "Cases" model (marked by a horizontal gray line) 
is comparable to that of 12-day-ahead forecasts from the "Cases + Facebook" model. 
So you could say that using the % CLI-in-community signal from our Facebook survey 
buys us *5 extra days of lead time* for this forecasting problem, 
which seems pretty nontrivial. 
