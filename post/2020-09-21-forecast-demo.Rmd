...
predictions, and records errors. It takes a little while to run[^1], the culprit 
...
file; you can find this in the [same GitHub 
repo](https://github.com/cmu-delphi/delphi-blog/tree/main/content/post) as that
containing the Rmd source for this blog post.
...
a [sign test](https://en.wikipedia.org/wiki/Sign_test)[^2] for whether the 
