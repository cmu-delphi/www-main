...
of scaled errors. The p-values from the "Cases" versus "Cases + Facecbook" 
...
"Cases + Facebook" model, and this is true for both 7 and 14 day ahead 
forecasts.
...
insights from our Facebook symptom survey data. The Challenge makes available
extensive aggregate data from the surveys, and submissions are due September
29th, with finalists eligible for large cash prizes. We look forward to seeing
how you put our data to use!
