...
Our group was founded in 2012 to advance research in epidemic forecasting.
Since March 2020, we have refocused efforts towards helping combat the COVID-19
pandemic, by supporting informed decision making at federal, state, and local 
levels of government and in the healthcare sector. Until now, we've been pretty 
"heads down" with our work, and slow to communicate what we've been up to.
But at last... Delphi finally has a blog!
This first post serves as an introduction of sorts.
Future posts will dive deeper into our various projects.
...
- Two of our indicators are based on massive-scale surveys 
  that we're running through partnerships with Facebook and Google
  and others are enabled by unprecedented access 
  to (de-identified) medical claims data, 
  through partners like Change Healthcare.
...
- We've built a [public 
  ...
  to serve our indicators to researchers and the public. This API provides new data daily.

- We've built [interactive maps and graphics](https://covidcast.cmu.edu/) to 
